...
#include "Tests/HoudiniEditorTestUtils.h"
...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniEditorTestObject;
UClass* UHoudiniEditorTestObject::GetPrivateStaticClass()
{
	using TClass = UHoudiniEditorTestObject;
	if (!Z_Registration_Info_UClass_UHoudiniEditorTestObject.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniEditorTestObject"),
			Z_Registration_Info_UClass_UHoudiniEditorTestObject.InnerSingleton,
			StaticRegisterNativesUHoudiniEditorTestObject,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniEditorTestObject.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniEditorTestObject_NoRegister()
{
	return UHoudiniEditorTestObject::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UHoudiniEditorTestObject_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UHoudiniEditorTestObject_PostCookCallback, "PostCookCallback" }, // 2822445973
		{ &Z_Construct_UFunction_UHoudiniEditorTestObject_PostInstantiationCallback, "PostInstantiationCallback" }, // 445380817
		{ &Z_Construct_UFunction_UHoudiniEditorTestObject_PostProcessingCallback, "PostProcessingCallback" }, // 572193889
		{ &Z_Construct_UFunction_UHoudiniEditorTestObject_PreInstantiationCallback, "PreInstantiationCallback" }, // 2116633562
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_Tests_HoudiniEditorTestUtils_h__Script_HoudiniEngineEditor_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniEditorTestObject, UHoudiniEditorTestObject::StaticClass, TEXT("UHoudiniEditorTestObject"), &Z_Registration_Info_UClass_UHoudiniEditorTestObject, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniEditorTestObject), 1991781916U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_Tests_HoudiniEditorTestUtils_h__Script_HoudiniEngineEditor_2850164773(TEXT("/Script/HoudiniEngineEditor"),
	Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_Tests_HoudiniEditorTestUtils_h__Script_HoudiniEngineEditor_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_Tests_HoudiniEditorTestUtils_h__Script_HoudiniEngineEditor_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
