...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniToolDirectoryProperties;
UClass* UHoudiniToolDirectoryProperties::GetPrivateStaticClass()
{
	using TClass = UHoudiniToolDirectoryProperties;
	if (!Z_Registration_Info_UClass_UHoudiniToolDirectoryProperties.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniToolDirectoryProperties"),
			Z_Registration_Info_UClass_UHoudiniToolDirectoryProperties.InnerSingleton,
			StaticRegisterNativesUHoudiniToolDirectoryProperties,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniToolDirectoryProperties.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniToolDirectoryProperties_NoRegister()
{
	return UHoudiniToolDirectoryProperties::GetPrivateStaticClass();
}
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UHoudiniToolDirectoryProperties_Statics::NewProp_CustomHoudiniToolsDirectories_Inner = { "CustomHoudiniToolsDirectories", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FHoudiniToolDirectory, METADATA_PARAMS(0, nullptr) }; // 211465968
...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniToolHelpers;
UClass* UHoudiniToolHelpers::GetPrivateStaticClass()
{
	using TClass = UHoudiniToolHelpers;
	if (!Z_Registration_Info_UClass_UHoudiniToolHelpers.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniToolHelpers"),
			Z_Registration_Info_UClass_UHoudiniToolHelpers.InnerSingleton,
			StaticRegisterNativesUHoudiniToolHelpers,
			sizeof(TClass),
			alignof(TClass),
			TClass::StaticClassFlags,
			TClass::StaticClassCastFlags(),
	...
	return Z_Registration_Info_UClass_UHoudiniToolHelpers.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniToolHelpers_NoRegister()
{
	return UHoudiniToolHelpers::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_SHoudiniToolsPanel_h__Script_HoudiniEngineEditor_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniToolDirectoryProperties, UHoudiniToolDirectoryProperties::StaticClass, TEXT("UHoudiniToolDirectoryProperties"), &Z_Registration_Info_UClass_UHoudiniToolDirectoryProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniToolDirectoryProperties), 2777634097U) },
		{ Z_Construct_UClass_UHoudiniToolHelpers, UHoudiniToolHelpers::StaticClass, TEXT("UHoudiniToolHelpers"), &Z_Registration_Info_UClass_UHoudiniToolHelpers, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniToolHelpers), 416951554U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_SHoudiniToolsPanel_h__Script_HoudiniEngineEditor_2897745883(TEXT("/Script/HoudiniEngineEditor"),
	Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_SHoudiniToolsPanel_h__Script_HoudiniEngineEditor_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_SHoudiniToolsPanel_h__Script_HoudiniEngineEditor_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_SHoudiniToolsPanel_h__Script_HoudiniEngineEditor_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_SHoudiniToolsPanel_h__Script_HoudiniEngineEditor_Statics::EnumInfo));
// ********** End Registration *********************************************************************
