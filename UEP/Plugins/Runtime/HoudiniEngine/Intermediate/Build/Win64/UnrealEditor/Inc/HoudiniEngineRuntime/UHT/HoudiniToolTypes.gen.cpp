...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FCategoryRules;
class UScriptStruct* FCategoryRules::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FCategoryRules.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FCategoryRules.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCategoryRules, (UObject*)Z_Construct_UPackage__Script_HoudiniEngineRuntime(), TEXT("CategoryRules"));
	}
	return Z_Registration_Info_UScriptStruct_FCategoryRules.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FCategoryRules.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FCategoryRules.InnerSingleton, Z_Construct_UScriptStruct_FCategoryRules_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FCategoryRules.InnerSingleton;
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniToolTypes_h__Script_HoudiniEngineRuntime_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FCategoryRules::StaticStruct, Z_Construct_UScriptStruct_FCategoryRules_Statics::NewStructOps, TEXT("CategoryRules"), &Z_Registration_Info_UScriptStruct_FCategoryRules, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCategoryRules), 3220661431U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniToolTypes_h__Script_HoudiniEngineRuntime_3510328620(TEXT("/Script/HoudiniEngineRuntime"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniToolTypes_h__Script_HoudiniEngineRuntime_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniToolTypes_h__Script_HoudiniEngineRuntime_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniToolTypes_h__Script_HoudiniEngineRuntime_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniToolTypes_h__Script_HoudiniEngineRuntime_Statics::EnumInfo));
// ********** End Registration *********************************************************************
