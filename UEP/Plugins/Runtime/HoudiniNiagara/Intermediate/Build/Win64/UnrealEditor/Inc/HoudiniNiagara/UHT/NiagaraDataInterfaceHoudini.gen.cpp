...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FHoudiniEvent;
class UScriptStruct* FHoudiniEvent::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniEvent.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FHoudiniEvent.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniEvent, (UObject*)Z_Construct_UPackage__Script_HoudiniNiagara(), TEXT("HoudiniEvent"));
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniEvent.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniEvent.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FHoudiniEvent.InnerSingleton, Z_Construct_UScriptStruct_FHoudiniEvent_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniEvent.InnerSingleton;
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UNiagaraDataInterfaceHoudini;
UClass* UNiagaraDataInterfaceHoudini::GetPrivateStaticClass()
{
	using TClass = UNiagaraDataInterfaceHoudini;
	if (!Z_Registration_Info_UClass_UNiagaraDataInterfaceHoudini.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("NiagaraDataInterfaceHoudini"),
			Z_Registration_Info_UClass_UNiagaraDataInterfaceHoudini.InnerSingleton,
			StaticRegisterNativesUNiagaraDataInterfaceHoudini,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UNiagaraDataInterfaceHoudini.InnerSingleton;
}
UClass* Z_Construct_UClass_UNiagaraDataInterfaceHoudini_NoRegister()
{
	return UNiagaraDataInterfaceHoudini::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniNiagara_Source_HoudiniNiagara_Classes_NiagaraDataInterfaceHoudini_h__Script_HoudiniNiagara_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FHoudiniEvent::StaticStruct, Z_Construct_UScriptStruct_FHoudiniEvent_Statics::NewStructOps, TEXT("HoudiniEvent"), &Z_Registration_Info_UScriptStruct_FHoudiniEvent, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniEvent), 1406340380U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraDataInterfaceHoudini, UNiagaraDataInterfaceHoudini::StaticClass, TEXT("UNiagaraDataInterfaceHoudini"), &Z_Registration_Info_UClass_UNiagaraDataInterfaceHoudini, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraDataInterfaceHoudini), 149794527U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniNiagara_Source_HoudiniNiagara_Classes_NiagaraDataInterfaceHoudini_h__Script_HoudiniNiagara_3167933865(TEXT("/Script/HoudiniNiagara"),
	Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniNiagara_Source_HoudiniNiagara_Classes_NiagaraDataInterfaceHoudini_h__Script_HoudiniNiagara_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniNiagara_Source_HoudiniNiagara_Classes_NiagaraDataInterfaceHoudini_h__Script_HoudiniNiagara_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniNiagara_Source_HoudiniNiagara_Classes_NiagaraDataInterfaceHoudini_h__Script_HoudiniNiagara_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniNiagara_Source_HoudiniNiagara_Classes_NiagaraDataInterfaceHoudini_h__Script_HoudiniNiagara_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
