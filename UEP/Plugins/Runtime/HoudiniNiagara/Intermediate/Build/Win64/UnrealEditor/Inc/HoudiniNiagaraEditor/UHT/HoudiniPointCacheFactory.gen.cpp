...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniPointCacheFactory;
UClass* UHoudiniPointCacheFactory::GetPrivateStaticClass()
{
	using TClass = UHoudiniPointCacheFactory;
	if (!Z_Registration_Info_UClass_UHoudiniPointCacheFactory.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniPointCacheFactory"),
			Z_Registration_Info_UClass_UHoudiniPointCacheFactory.InnerSingleton,
			StaticRegisterNativesUHoudiniPointCacheFactory,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniPointCacheFactory.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniPointCacheFactory_NoRegister()
{
	return UHoudiniPointCacheFactory::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniNiagara_Source_HoudiniNiagaraEditor_Public_HoudiniPointCacheFactory_h__Script_HoudiniNiagaraEditor_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniPointCacheFactory, UHoudiniPointCacheFactory::StaticClass, TEXT("UHoudiniPointCacheFactory"), &Z_Registration_Info_UClass_UHoudiniPointCacheFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniPointCacheFactory), 3975057571U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniNiagara_Source_HoudiniNiagaraEditor_Public_HoudiniPointCacheFactory_h__Script_HoudiniNiagaraEditor_2324290550(TEXT("/Script/HoudiniNiagaraEditor"),
	Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniNiagara_Source_HoudiniNiagaraEditor_Public_HoudiniPointCacheFactory_h__Script_HoudiniNiagaraEditor_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniNiagara_Source_HoudiniNiagaraEditor_Public_HoudiniPointCacheFactory_h__Script_HoudiniNiagaraEditor_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
