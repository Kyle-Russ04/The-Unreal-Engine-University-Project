...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FPointIndexes;
class UScriptStruct* FPointIndexes::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FPointIndexes.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FPointIndexes.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPointIndexes, (UObject*)Z_Construct_UPackage__Script_HoudiniNiagara(), TEXT("PointIndexes"));
	}
	return Z_Registration_Info_UScriptStruct_FPointIndexes.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FPointIndexes.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FPointIndexes.InnerSingleton, Z_Construct_UScriptStruct_FPointIndexes_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FPointIndexes.InnerSingleton;
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniPointCache;
UClass* UHoudiniPointCache::GetPrivateStaticClass()
{
	using TClass = UHoudiniPointCache;
	if (!Z_Registration_Info_UClass_UHoudiniPointCache.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniPointCache"),
			Z_Registration_Info_UClass_UHoudiniPointCache.InnerSingleton,
			StaticRegisterNativesUHoudiniPointCache,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniPointCache.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniPointCache_NoRegister()
{
	return UHoudiniPointCache::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UHoudiniPointCache_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetAttributeIndexFromString, "GetAttributeIndexFromString" }, // 929207941
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetAttributeIndexInArrayFromString, "GetAttributeIndexInArrayFromString" }, // 4106567005
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetColorValue, "GetColorValue" }, // 2028003905
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetFloatSampleData, "GetFloatSampleData" }, // 529911290
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetFloatValue, "GetFloatValue" }, // 2671978403
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetFloatValueForString, "GetFloatValueForString" }, // 2787866450
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetImpulseValue, "GetImpulseValue" }, // 1668621323
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetLastPointIDToSpawnAtTime, "GetLastPointIDToSpawnAtTime" }, // 2290759167
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetLastSampleIndexAtTime, "GetLastSampleIndexAtTime" }, // 2597435840
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetLifeValues, "GetLifeValues" }, // 2751333874
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetNormalValue, "GetNormalValue" }, // 2248089694
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetNumberOfAttributes, "GetNumberOfAttributes" }, // 1792646539
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetNumberOfPoints, "GetNumberOfPoints" }, // 2302780102
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetNumberOfSamples, "GetNumberOfSamples" }, // 855998227
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetPointFloatValueAtTime, "GetPointFloatValueAtTime" }, // 3662156593
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetPointIDsToSpawnAtTime, "GetPointIDsToSpawnAtTime" }, // 4274424976
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetPointInt32ValueAtTime, "GetPointInt32ValueAtTime" }, // 1042572104
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetPointLife, "GetPointLife" }, // 1262316342
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetPointLifeAtTime, "GetPointLifeAtTime" }, // 168714168
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetPointPositionAtTime, "GetPointPositionAtTime" }, // 164238931
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetPointQuatValueAtTime, "GetPointQuatValueAtTime" }, // 2232697507
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetPointQuatValueAtTimeForString, "GetPointQuatValueAtTimeForString" }, // 3976109101
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetPointType, "GetPointType" }, // 473690438
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetPointTypes, "GetPointTypes" }, // 1005880912
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetPointValueAtTime, "GetPointValueAtTime" }, // 1193371938
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetPointValueAtTimeForString, "GetPointValueAtTimeForString" }, // 2323919541
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetPointValueIndexes, "GetPointValueIndexes" }, // 4001073288
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetPointVector4ValueAtTime, "GetPointVector4ValueAtTime" }, // 3401041174
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetPointVector4ValueAtTimeForString, "GetPointVector4ValueAtTimeForString" }, // 2128777158
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetPointVectorValueAtTime, "GetPointVectorValueAtTime" }, // 1089360024
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetPointVectorValueAtTimeForString, "GetPointVectorValueAtTimeForString" }, // 2057890253
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetPositionValue, "GetPositionValue" }, // 3263339112
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetQuatValue, "GetQuatValue" }, // 3379890763
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetQuatValueForString, "GetQuatValueForString" }, // 3986022973
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetSampleIndexesForPointAtTime, "GetSampleIndexesForPointAtTime" }, // 4130569751
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetSpawnTimes, "GetSpawnTimes" }, // 1938157785
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetSpecialAttributeIndexes, "GetSpecialAttributeIndexes" }, // 1932733649
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetTimeValue, "GetTimeValue" }, // 13896986
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetUseCustomCSVTitleRow, "GetUseCustomCSVTitleRow" }, // 3857931036
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetVector4Value, "GetVector4Value" }, // 3031203488
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetVector4ValueForString, "GetVector4ValueForString" }, // 4231719262
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetVectorValue, "GetVectorValue" }, // 1367463635
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetVectorValueForString, "GetVectorValueForString" }, // 518671858
		{ &Z_Construct_UFunction_UHoudiniPointCache_GetVelocityValue, "GetVelocityValue" }, // 176199038
		{ &Z_Construct_UFunction_UHoudiniPointCache_SetUseCustomCSVTitleRow, "SetUseCustomCSVTitleRow" }, // 15102700
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniNiagara_Source_HoudiniNiagara_Public_HoudiniPointCache_h__Script_HoudiniNiagara_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FPointIndexes::StaticStruct, Z_Construct_UScriptStruct_FPointIndexes_Statics::NewStructOps, TEXT("PointIndexes"), &Z_Registration_Info_UScriptStruct_FPointIndexes, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPointIndexes), 1364897068U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniPointCache, UHoudiniPointCache::StaticClass, TEXT("UHoudiniPointCache"), &Z_Registration_Info_UClass_UHoudiniPointCache, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniPointCache), 576668588U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniNiagara_Source_HoudiniNiagara_Public_HoudiniPointCache_h__Script_HoudiniNiagara_3345196807(TEXT("/Script/HoudiniNiagara"),
	Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniNiagara_Source_HoudiniNiagara_Public_HoudiniPointCache_h__Script_HoudiniNiagara_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniNiagara_Source_HoudiniNiagara_Public_HoudiniPointCache_h__Script_HoudiniNiagara_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniNiagara_Source_HoudiniNiagara_Public_HoudiniPointCache_h__Script_HoudiniNiagara_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniNiagara_Source_HoudiniNiagara_Public_HoudiniPointCache_h__Script_HoudiniNiagara_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniNiagara_Source_HoudiniNiagara_Public_HoudiniPointCache_h__Script_HoudiniNiagara_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniNiagara_Source_HoudiniNiagara_Public_HoudiniPointCache_h__Script_HoudiniNiagara_Statics::EnumInfo));
// ********** End Registration *********************************************************************
