...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniPointCacheExporterHCSV;
UClass* UHoudiniPointCacheExporterHCSV::GetPrivateStaticClass()
{
	using TClass = UHoudiniPointCacheExporterHCSV;
	if (!Z_Registration_Info_UClass_UHoudiniPointCacheExporterHCSV.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniPointCacheExporterHCSV"),
			Z_Registration_Info_UClass_UHoudiniPointCacheExporterHCSV.InnerSingleton,
			StaticRegisterNativesUHoudiniPointCacheExporterHCSV,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniPointCacheExporterHCSV.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniPointCacheExporterHCSV_NoRegister()
{
	return UHoudiniPointCacheExporterHCSV::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniNiagara_Source_HoudiniNiagaraEditor_Private_HoudiniPointCacheExporterHCSV_h__Script_HoudiniNiagaraEditor_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniPointCacheExporterHCSV, UHoudiniPointCacheExporterHCSV::StaticClass, TEXT("UHoudiniPointCacheExporterHCSV"), &Z_Registration_Info_UClass_UHoudiniPointCacheExporterHCSV, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniPointCacheExporterHCSV), 989236608U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniNiagara_Source_HoudiniNiagaraEditor_Private_HoudiniPointCacheExporterHCSV_h__Script_HoudiniNiagaraEditor_2594887934(TEXT("/Script/HoudiniNiagaraEditor"),
	Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniNiagara_Source_HoudiniNiagaraEditor_Private_HoudiniPointCacheExporterHCSV_h__Script_HoudiniNiagaraEditor_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UEP_Plugins_Runtime_HoudiniNiagara_Source_HoudiniNiagaraEditor_Private_HoudiniPointCacheExporterHCSV_h__Script_HoudiniNiagaraEditor_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
